		...
		<form data-confirm="1" method="POST" action="<?=base_url($instance.'/action_edit/'.$id)?>" class="form-horizontal form-add" role="form">
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="touch_judul" type="text" maxlength="150" class="required form-control" placeholder="Title" value="<?=$records->touch_judul?>" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<textarea name="touch_isi" class="form-control" placeholder="Content"><?=$records->touch_isi?></textarea>
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="touch_link" type="text" maxlength="255" class="required form-control" placeholder="Link" value="<?=$records->touch_link?>" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
								<img class="img-edit" src="<?=base_url("../public/images/touch_touch/".$records->touch_pict)?>" alt="">
							</div>
							<div>
