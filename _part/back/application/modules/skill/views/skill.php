	...
	<div class="portlet-body">
		<div class="table-container">
			...
			<tr role="row" class="filter display-hide">
				...
				<td>
					<input type="text" class="form-control form-filter input-sm" placeholder="group" name="group">
				</td>
				<td>
					<input type="text" class="form-control form-filter input-sm" placeholder="skill_name" name="skill name">
				</td>
				<td>
					<select class="form-control form-filter input-sm" placeholder="range" name="range">
						<option value=""></option>
