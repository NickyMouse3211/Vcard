...
<head>
	<meta charset="utf-8"/>
	<title><?=$this->config->item('app_name').' - '.$pagetitle?></title>
	...
	<link href="<?=base_url('../public/back/admin/pages/css/login.css')?>" rel="stylesheet" type="text/css"/>
	<!-- END PAGE LEVEL SCRIPTS -->
	<!-- BEGIN THEME STYLES -->
	<link href="<?=base_url('../public/back/global/css/components.css" id="style_components')?>" rel="stylesheet" type="text/css"/>
	<link href="<?=base_url('../public/back/global/css/plugins.css')?>" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<!-- <img src="<?=base_url('public/back/admin/layout2/img/logo-big.png')?>" alt=""/> -->
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="<?=base_url('public/back/global/plugins/respond.min.js')?>"></script>
<script src="<?=base_url('public/back/global/plugins/excanvas.min.js')?>"></script> 
<![endif]-->
...
<script src="<?=base_url('../public/back/global/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js')?>" type="text/javascript"></script>
