		...
		<form data-confirm="1" method="POST" action="<?=base_url($instance.'/action_edit/'.$id)?>" class="form-horizontal form-add" role="form">
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="touchgallery_judul" type="text" maxlength="150" class="required form-control" placeholder="Title" value="<?=$records->touchgallery_judul?>" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<textarea name="touchgallery_isi" class="form-control" placeholder="Content"><?=$records->touchgallery_isi?></textarea>
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="touchgallery_link" type="text" maxlength="255" class="form-control" placeholder="Link" value="<?=$records->touchgallery_link?>" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
								<img class="img-edit" src="<?=base_url("../public/images/touch_galery/".$records->touchgallery_pict)?>" alt="">
							</div>
							<div>
