		...
		<form data-confirm="1" method="POST" action="<?=base_url($instance.'/action_edit/'.$id)?>" class="form-horizontal form-add" role="form">
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="touchartikel_judul" type="text" maxlength="150" class="required form-control" placeholder="Title" value="<?=$records->touchartikel_judul?>" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<textarea name="touchartikel_isi" class="form-control" placeholder="Content"><?=$records->touchartikel_isi?></textarea>
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="touchartikel_link" type="text" maxlength="255" class="required form-control" placeholder="Link" value="<?=$records->touchartikel_link?>" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
