		...
		<form data-confirm="1" method="POST" action="<?=base_url($instance.'/action_edit/'.$id)?>" class="form-horizontal form-add" role="form">
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="fierce_judul" type="text" maxlength="150" class="required form-control" placeholder="Title" value="<?=$records->fierce_judul?>" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<textarea name="fierce_isi" class="form-control" placeholder="Content"><?=$records->fierce_isi?></textarea>
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="fierce_link" type="text" maxlength="255" class="form-control" placeholder="Link" value="<?=$records->fierce_link?>" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
