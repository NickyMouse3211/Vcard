		...
		<form method="POST" action="<?=base_url($instance.'/action_add')?>" class="form-horizontal form-add" role="form" >
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="fierce_judul" type="text" maxlength="150" class="required form-control" placeholder="Title" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<textarea name="fierce_isi" class="form-control" placeholder="Content"></textarea>
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4">
						<input name="fierce_link" type="text" maxlength="255" class="form-control" placeholder="Link" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="form-group">
