...
var Metronic = function() {
    ...
    var assetsPath = base_url+'../public/back/';
    ...
    return {
        ...
        init: function() {
            ...
            handleFilterToggle();//find toggle
        ...
        getGlobalImgPath: function() {
            var link = base_url+'../public/back/global/img/';
            return link;
        },
    ...
    $.ajax({
        ...
        error: function(xhr, ajaxOptions, thrownError) {
            $.ajax({
                ...
                cache: false,
                url: 'error/error_404',
                data: {url: ajaxify[1], url1: ajaxify[2], status_link: true},
                dataType: "html",
                success: function(res) {
                    Metronic.stopPageLoading();
                    pageContentBody.html(res);
...
function f_logout(ele, e){
    e.preventDefault();
    swal({
        title: "Are you sure?",
        text: 'closing the App ?',
        type: "warning",
...
function f_status(stat, ele, e){
    ...
    if(stat == 1){
        var tit = 'Change Status';
        var mes = "Are you sure to change status ?";
        var sus = "Status has been changed!";
        var err = "Failed to change status!";
    }else if(stat == 2){
        var tit = "Deleting data";
